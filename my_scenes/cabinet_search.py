...
class CabinetSearchTask(BaseEnv):
    ...
    def __init__(self, *args, robot_uids="ds_fetch", scene_idx: int | None = 0, **kwargs):
    ...
    def _load_scene(self, options: dict):
        ...
        # robot is an articulation too (key "ds_fetch") and is never a
        # kitchen joint.
    ...
    def evaluate(self) -> dict:
        ...
        # for traces and the Mac smoke — utils.test_planner's tally folds only
