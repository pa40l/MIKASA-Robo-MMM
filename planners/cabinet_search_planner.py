...
Run (container; mplib):
  tools/docker/planner.sh run --timeout 5400 python -m utils.test_planner \\
...
def plan_joints(*args, **kwargs):
    kwargs["who"] = WHO
    return common.plan_joints(*args, **kwargs)
...
def door_spec_for(compartment, *, closed_rad: float | None = None) -> DoorSpec:
    ...
    Example:
        >>> from my_scenes.cabinet_search import DEFAULT_COMPARTMENTS
